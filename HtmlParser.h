...
enum HtmlNodeType
{
	...
	_NODE_USER_ = 10, //用户定义的其他节点类型值应大于_NODE_USER_，以确保不与上面定义的常量值重复
};
...
enum HtmlTagType
{
	...
	TAG_A = 101, TAG_ABBR, TAG_ACRONYM, TAG_ADDRESS, TAG_APPLET, TAG_AREA, TAG_ARTICLE, TAG_ASIDE, TAG_AUDIO, 
	...
	_TAG_USER_TAG_ = 300, //用户定义的其他标签类型值应大于_TAG_USER_TAG_，以确保不与上面定义的常量值重复
};
